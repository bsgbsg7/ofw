"""
Stage 3: Extended fine-tuning for OTFS variant.
"""
import sys
import pickle
import os
...
best_ber = 1.0
patience_counter = 0
print(f"Stage 3 (OTFS): Extended fine-tuning for up to {NUM_ITERS} iterations")
...
print(f"Stage 3 (OTFS) complete. Best BER@20dB: {best_ber:.5f}")
